...
if (allGames == null) {
    response.sendRedirect("AllGamesServlet");
    return;
}
...
<title>Inicio - Pixel Portal</title>
<link rel="stylesheet"
			...
			<div class="row">
				...
				<div class="col-md-3 m-0 p-0">
					<div class="primeraColumna">
						<form
							class="formClasificacion col-sm-3 col-md-3 mx-auto text-center"
							method="GET" action="FilterGamesServlet">
							<b class="d-block mb-4">Filtra por género de juego</b> <select
								class="form-select w-75 mx-auto" name="category">
							...
							</select> <label for="min-price" class="mt-4">Precio mínimo:</label> <input
								type="range" id="min-price" name="min-price" min="0" max="50"
								step="1" value="0">
							<div id="min-price-label">0</div>
							<br> <label for="max-price">Precio máximo:</label> <input
								type="range" id="max-price" name="max-price" min="0" max="50"
								step="1" value="50">
							<div id="max-price-label">50</div>
							<br>
							<button  class="efectoBoton w-50 mt-3 text-white rounded border border-primary" type="submit">Aplicar</button>
						</form>
						...
						<section class="row mb-4">
							<div class="col-lg-12">
								<div class="container mt-5">
									<h4
										class="text-uppercase fw-light mt-3 ms-3 lh-lg">Títulos
										disponibles:</h4>
									<div class="row">
										<%
										...
										%>
<article class="p-2 mt-3 bordeArticle col-12 col-md-6 col-lg-4 mx-auto d-flex flex-column fondoGuay">
    <a href="GameViewServlet?gameId=<%=game.getGameId()%>" class="text-decoration-none fondoGuay">
        <div class="ratio ratio-4x3">
            <img src="<%=game.getCoverImageUrl()%>" class="img-fluid" alt="<%=game.getTitle()%>" style="object-fit: contain;">
        </div>
        <h2 class="mt-3 text-capitalize"><%=game.getTitle()%></h2>
        <div class="mt-auto">
