...
<title>¡Únete! - Pixel Portal</title>
						...
						<div class="col-md-6 form-container">
							...
							<form method="post" action="RegisterServlet" class="register-form" id="register-form">
								...
								<div class="mb-3">
									...
									<input type="password" name="password" id="password" class="form-control" placeholder="Contraseña" data-bs-toggle="tooltip" data-bs-placement="right" title="Mínimo 8 caracteres, incluyendo una mayúscula y un carácter especial." required>
								</div>
								<div class="mb-3">
								...
								<div class="form-check mb-3">
									...
									<label for="agree-term" class="form-check-label">Acepto todas las condiciones en <a href="#" class="term-service text-info">Términos de servicio</a></label>
								</div>
								<div class="mb-3">
