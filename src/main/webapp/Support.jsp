...
<title>Atención al Cliente - Pixel Portal</title>
<link rel="stylesheet"
	...
	<div class="container-fluid">
		...
		<main>
			<div class="container mt-5">
				...
				<p>¡Si tienes alguna pregunta o necesitas ayuda, no dudes en
					ponerte en contacto con nosotros a través del siguiente formulario!</p>
				<form action="SubmitSupportRequestServlet" method="POST">
					<div class="mb-3">
					...
					<div class="mb-3">
						<label for="category" class="form-label">Categoría de la
							consulta:</label> <select class="form-select" id="category"
							name="category" required>
							<option value="consultas-generales" selected>Consultas
								generales</option>
							<option value="problemas-inicio-sesion">Problemas de
								inicio de sesión</option>
							<option value="recuperacion-contrasena">Recuperación de
								contraseña</option>
							<option value="problemas-facturacion-pagos">Problemas de
								facturación y pagos</option>
							<option value="errores-fallos-tecnicos">Errores y fallos
								técnicos</option>
							<option value="devoluciones-reembolsos">Devoluciones y
								reembolsos</option>
							<option value="problemas-aplicacion-movil">Problemas con
								la aplicación móvil</option>
							<option value="consultas-generales">Consultas generales</option>
							<option value="cancelacion-cuenta">Cancelación de cuenta</option>
							<option value="reportar-problema-seguridad">Reportar un
								problema de seguridad</option>
							<option value="solicitudes-mejora">Solicitudes de mejora</option>
							<option value="preguntas-frecuentes">FAQ (Preguntas
								frecuentes)</option>
						</select>
					</div>
					<div class="mb-3">
					...
					<button type="submit" class="btn btn-primary efectoBoton">Enviar</button>
				</form>
			</div>
		</main>
